...
public class TestInfoLeak {
	...
	public static void main(String[] args) {
		...
		PrintLeakageValue plv = new PrintLeakageValue(PRINT_CHANNELMATRIX, PRINT_JOINTMATRIX, verbose, acceptableError, noOfIterations, OBS_DISCRETE, readFromChanFile, correctLeak, correctLeakNew);
